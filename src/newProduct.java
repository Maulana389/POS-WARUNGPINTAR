...
public class newProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 250, -1));

        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(153, 153, 153));
        jTextField1.setText("Masukkan Produk");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 250, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 250, -1));

        jTextField3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(153, 153, 153));
        jTextField3.setText("Masukkan Deskripsi");
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 250, -1));

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "YES", "NO" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 250, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/judul-tambahproduk.png"))); // NOI18N
    ...
    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        ...
        if(jTextField1.getText().equals("Masukkan Produk")){
            jTextField1.setText("");
    ...
    private void jTextField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField2FocusGained
        // TODO add your handling code here:
        if(jTextField2.getText().equals("Masukkan Harga")){
            jTextField2.setText("");
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        // TODO add your handling code here:
        if(jTextField3.getText().equals("Masukkan Deskripsi")){
            jTextField3.setText("");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        ResultSet rs = st.executeQuery("select max(id) from produk");
        if(rs.first()){
            int id = rs.getInt(1);
            id = id + 1 ;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String produk = jTextField1.getText();
        ...
        }else if(produk.equals("")|!produk.matches("[a-z]*")){
            JOptionPane.showMessageDialog(null, "masukkan kembali");
        }else if(harga.equals("")||!harga.matches("[0-9]*")){
            JOptionPane.showMessageDialog(null, "masukkan kembali");
        }else{
            try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("insert into produk values('"+id+"','"+produk+"','"+harga+"','"+deskripsi+"','"+stok+"','"+aktif+"')");
